        ...
        <div class="m-stack__item m-brand m-brand--skin-dark">
          <div class="m-stack m-stack--ver m-stack--general">
            <div class="m-stack__item m-stack__item--middle m-brand__logo">
              <router-link to="dashboard" class="m-brand__logo-wrapper">
                <img alt="" src="images/logo/logo_default_dark.png" />
              </router-link>
            </div>
              ...
              <ul class="m-topbar__nav m-nav m-nav--inline">
                ...
                >
                  <a href="#" class="m-nav__link m-dropdown__toggle">
                    ...
                    <span class="m-topbar__username m--hide">{{ authUser.name }}</span>
                  </a>
...
export default {
  ...
  methods: {
    logout() {
      this.$toasted.success("Goodbye " + this.authUser.name).goAway(1000);
      setTimeout(() => {

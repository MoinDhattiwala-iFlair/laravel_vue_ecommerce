    ...
    >
      ...
      >
        ...
        <form method="POST" @submit.prevent="login">
          <!-- Email Address -->
          <div :class="{ 'form-group--error': $v.user.email.$error }">
            ...
            <ul>
              <li class="error" v-for="(err, index) in errors.email" :key="index">
                {{ err }}
              </li>
            </ul>
          </div>
          ...
          <div class="mt-4">
            ...
            <ul>
              <li class="error" v-for="(err, index) in errors.password" :key="index">
                {{ err }}
              </li>
            </ul>
          </div>
          ...
          <div class="flex items-center justify-end mt-4">
            <a
              ...
              href="http://localhost/forgot-password"
            >
